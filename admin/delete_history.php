...
?>
    ...
    <body>
        <div class="warning-box">
            <h2>Peringatan!</h2>
            <p>Anda akan menghapus <strong>seluruh data <strong>history tindakan</strong> dan data kehadiran<strong></strong>.</p>
...
try {
    ...
    echo "<script>alert('Semua data history berhasil dihapus!'); window.location.href='schedule_history.php';</script>";
} catch (Exception $e) {
